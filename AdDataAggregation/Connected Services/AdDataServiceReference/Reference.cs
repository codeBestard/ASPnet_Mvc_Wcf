...
namespace AdDataAggregation.AdDataServiceReference {
    ...
    public partial class Ad : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private AdDataAggregation.AdDataServiceReference.Brand BrandField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public AdDataAggregation.AdDataServiceReference.Brand Brand {
            get {
    ...
    public interface IAdDataService {
        ...
        AdDataAggregation.AdDataServiceReference.Ad[] GetAdDataByDateRange(System.DateTime startDate, System.DateTime endDate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdDataService/GetAdDataByDateRange", ReplyAction="http://tempuri.org/IAdDataService/GetAdDataByDateRangeResponse")]
        System.Threading.Tasks.Task<AdDataAggregation.AdDataServiceReference.Ad[]> GetAdDataByDateRangeAsync(System.DateTime startDate, System.DateTime endDate);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAdDataServiceChannel : AdDataAggregation.AdDataServiceReference.IAdDataService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AdDataServiceClient : System.ServiceModel.ClientBase<AdDataAggregation.AdDataServiceReference.IAdDataService>, AdDataAggregation.AdDataServiceReference.IAdDataService {
        ...
        public AdDataAggregation.AdDataServiceReference.Ad[] GetAdDataByDateRange(System.DateTime startDate, System.DateTime endDate) {
            return base.Channel.GetAdDataByDateRange(startDate, endDate);
        }
        
        public System.Threading.Tasks.Task<AdDataAggregation.AdDataServiceReference.Ad[]> GetAdDataByDateRangeAsync(System.DateTime startDate, System.DateTime endDate) {
